...
<!--[if lt IE 9]><LINK rel=stylesheet type=text/css href="css/ie.css"><![endif]-->
    ...
    <body>
        <div id="signup_hold">
            <div id="header">
                <div id="header_logos"><img align="middle" src="pnews1 (1).jpg" alt="phr"></div>
					<div id="progress_bar"> </div>
						<h2>5 including 4 of a family killed as storm lashes in Netrakona,April 28th, 2014</h2>
            </div>
									 ...
									 <div id="content">
										<table align="center" cellpadding="5" cellspacing="5" id="resultTable">
											<tr>
												...
												<?php
												include('connect.php');
												$result = mysql_query("SELECT * FROM aff_area WHERE area='Netrakona'");
