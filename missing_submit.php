...
if($_POST['action']=='add')
{
		...
		$query2 = mysql_query("INSERT INTO missing_person_info (id,name,username,permanent_address,situation,national_id,password ,confirm_password,phone,city,post_code,shortbio,present_address,gender,img)
...
//$err="Username Already Taked. try with another username."
	...
	header("Location: missing_person_signup.php?err=ok");
	exit;
}
?>
