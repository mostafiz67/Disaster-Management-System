...
$().ready(function() {
	...
	$("#signupForm").validate({
		...
		messages: {
			...
			post_code :{
				required : "Enter your Area Where your Organization is situated",
				},
			national_id :{
				required : "Enter your national id",
				},
			city_org :{
				required : "Enter the name of city where your organization is situated",
				},
		}
	});
});
	...
	<div id="homepage_content_hold">
		<div class="container">
			<div id="hero"><img src="DMS%20pass_files/for_individual.jpg"></div>
				<h2 align="center">Registration Form For Organization Author</h2>
			<div style="text-align:;">
				<form class="cmxform" action="picture.php" id="signupForm" method="POST" enctype="multipart/form-data">
					<table style="width: auto; height: auto; margin: 0 auto;" border="1">
						<tbody>
						<tr>
							<td><strong>Full Name Of Organization :</strong></td>
							<td><input id="name_org" name="name_org" style="width:185px" type="text"></td>
						</tr>
						<tr>
							<td><label for="city_org"><strong>City Of Organization</strong></label></td>
							<td><select id="city_org" name="city_org">
									<option selected="selected" value="chittagong">Chittagong</option>
						...
						<tr>
							...
							<td><input id="username" name="username" style="width:185px" type="text"><?php  echo $err; ?></td>
						</tr>
						...
						<tr>
							<td><label for="national_id"><strong>National_ID :</strong></label></td>
							<td><input id="national_id" name="national_id" style="width:185px" type="text"></td>
						</tr>
