...
<body>
<div id="main">
	<div id="header"><h1>Personal Information Of Missing Person  </h1></div>
	<div class="menu">
        <ul>
			<li><a href="found.php?usr=<?php echo $username;?>">Found</a></li>
		...
		<table cellpadding="1" cellspacing="1" id="resultTable">
			...
			mysql_data_seek($result, 0);
					while($row = mysql_fetch_array($result))
						{
							echo '<tr>';
							echo '<td>'. 'Name Of Missing Person:' . '</td>';
							echo '<td>'. $row['name'] . '</td>';
							echo'</tr>';
							echo '<tr>';
							echo '<td>'. 'Username:' . '</td>';
							...
							echo'<td>Image</td>';
							echo'<td>';
							echo"<img  alt='Responsive image' border=\"0\" src=\"".$row['img']."\" width=\"100\" alt=\"Image\" height=\"100\">";
							echo '</td>';
							echo'</tr>';
							echo'<tr>';
							echo'<td>'. 'Action :' . '</td>';
							echo '<td><div align="center"><a rel="facebox" href="missing_person_edit_profile.php?id='.$row['id'].'" title="Click To View Orders">Edit Profile</a></div></td>';
							echo'</tr>';
						}
			?>
		</table>
