...
{
$cid=$_GET['id'];
$sql=mysql_query("UPDATE notification SET vis='1' WHERE id='$cid'");
	...
	<div id="content">
		<table cellpadding="1" cellspacing="1" id="resultTable">
											<tr>
												...
												<?php
													include('connect.php');
													$result = mysql_query("SELECT * FROM notification WHERE position='admin'AND vis=0");
															while($row = mysql_fetch_array($result))
															{
																...
																echo '<td><div align="center"><a href="show_message_from_org.php?act=del&id='.$row['id'].'"   title="Click To Delete">Archive</a></div></td>';
																echo '</tr>';
															}
												?>
		</table>
