...
<div id="main">
	...
	<div id="content">
		<table cellpadding="1" cellspacing="1" id="resultTable">
											<tr>
												<th style="border-left: 1px solid #C1DAD7">Name Of Organization</th>
												<th>Name Of Organization Author</th>
												<th>Email</th>
												<th>Phone</th>
												<th>ID</th>
											</tr>
												<?php
													include('connect.php');
													$result = mysql_query("SELECT * FROM org_aut_info WHERE active=0");
															while($row = mysql_fetch_array($result))
															{
																
																echo '<tr>';
																echo '<td style="border-left: 1px solid #C1DAD7">'.$row['name_org'].'</td>';
