...
<div id="main">
	<div id="header"><h1>Message's From Admin</h1></div>
	<div class="menu">
        <ul>
			<li><a href="volunteer_message_show.php">Message From Admin</a></li>
	...
	<div id="content">
		<table cellpadding="1" cellspacing="1" id="resultTable">
											<tr>
												...
												<?php
													include('connect.php');
													$result = mysql_query("SELECT * FROM notification WHERE position='volunteer'");
