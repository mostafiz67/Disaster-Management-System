...
$().ready(function() {
	...
	$("#signupForm").validate({
		...
		messages: {
			...
			gender : {
				required : "plese enter the MISSING PERSON is male/female"
				},
			sit : {
				required : "plese enter"
				},
			name : {
				required : "Name of Missing people"
				},
			username : {
				required : "username of this person who do this work"
				},
			phone : {
	...
	<div id="homepage_content_hold">
		<div class="container">
			<div id="hero"><img src="DMS%20pass_files/for_individual.jpg"></div>
				<h2 align="center">Missing Person Registration Form</h2>
			<div style="text-align:;">
				<form class="cmxform" action="missing_submit.php" id="signupForm" method="POST" enctype="multipart/form-data">
					<table style="width: auto; height: auto; margin: 0 auto;" border="1">
					<tr>
							<td><strong>Name Of Missing Person :</strong></label></td>
						...
						<tr>
							...
							<td><input id="username" name="username" style="width:185px"></td>
						</tr>
						<tr>
							<td><strong> Password</strong></td>
							<td><input name="password" id="password" style="width:185px" type="password"><?php  echo $err; ?></td>
						</tr>
