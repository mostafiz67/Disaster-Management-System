...
<form name="myForm" action="edit_org_auth.php" method="post" enctype="multipart/form-data" name="addroom" onsubmit="return validateForm()">
...
<br>
City <br />
<select name="city_org" class="ed">
<option><?php echo $city_org?></option>
