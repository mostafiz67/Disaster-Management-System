                ...
                <tbody>
					<tr>
						<td class="customerSupport" width="50%">
							<fieldset>
								<form name="login_form" id="login_form" action="finding_person_log_confirm.php" method="post">	
							...
							<p>&nbsp;</p>
							<p><span class="small"><a href="finding_person_signup.php"><h3>Not yet registered! please click here</h3></a><br/></span></p>
                            </fieldset>
						</td>	
					</tr>
				</tbody>
